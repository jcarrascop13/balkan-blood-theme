...
<section class="hero novedades">
  <div class="hero-overlay">
    <h1>NEW DROPS</h1>
    <p>The latest available pieces.</p>
  </div>
</section>
...
<section class="section patron">
  ...
  <div class="collection-header">
    <h1>New Drops</h1>
    <p>Recently released pieces from Balkan Blood.</p>
  </div>

  <div class="product-grid">

    <!-- COPIA Y PEGA ESTE BLOQUE POR CADA PRODUCTO -->
    <div class="product-card">
      <div class="shopify-product" data-product-id="AQUI_TU_ID_DE_SHOPIFY"></div>
    </div>
